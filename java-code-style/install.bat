REM Installs Dr.Joy's IntelliJ configs into your user configs.
@echo off
echo Installing Dr.Joy IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'drjoy'.
exit /b
